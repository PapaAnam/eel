	...
	<b-row>
				...
				<my-card title="Employee To Attendance (One By One)">
					<b-row>
						...
						<b-col lg="12">
							...
							<b-form-select id="status" name="status" :options="$store.getters.absenceStatus"></b-form-select>
		...
		<b-col md="4" sm="6">
			<form id="multiply-form">
				<my-card title="Employee To Attendance (Multiple)">
					<div class="row">
						<div class="col-md-12">
...
<script>
	...
	export default{
		...
		mounted(){
			...
			$(this.$el).find('#status').val('Present')
		},
		components : {
			empSelect,
		},
